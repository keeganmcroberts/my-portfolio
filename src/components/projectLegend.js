    ...
    return(
        <div className="project-card">
              ...
              <div className="buttons">
                <a className="reference-link1"  href="https://github.com/keeganmcroberts/CapstoneProject" target="_blank">Code</a>
                <a className="reference-link2" href="https://www.loom.com/share/961db6b743d848a7b56ca38cb68a90f6" target="_blank">Demo</a>
              </div>
        </div>
    )
}
